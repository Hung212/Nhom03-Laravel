...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>BABY STORES {{trans('message.slogin')}} 24/24</h2>
                                                    ...
                                                    <div class="products-single fix">
                                                        <div class="card">
                                                            <div class="box-img-hover">
                                                                ...
                                                                <div class="mask-icon">
                                                                    <ul>
                                                                        <li><a href="{{url('/product-detail?id='.$item->id)}}" data-toggle="tooltip" data-placement="right" title="{{trans('message.View')}}"><i class="fas fa-eye"></i></a>
                                                        ...
                                                        <div class="why-text">
                                                            ...
                                                            <div>
                                                                ...
                                                                <i style="color: #bdbd3bfc" class="fa fa-star" aria-hidden="true"></i>
                                                                <i style="color: #bdbd3bfc" class="fa fa-star" aria-hidden="true"></i>
                                                                <i style="color: #bdbd3bfc" class="fa fa-star" aria-hidden="true"></i>
                                                                <i style="color: #bdbd3bfc" class="fa fa-star" aria-hidden="true"></i>
                                                                <i style="color: #bdbd3bfc" class="fa fa-star" aria-hidden="true"></i>
